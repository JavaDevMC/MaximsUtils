...
public abstract class CoreSession implements Session {
  ...
  protected static final Log NULL_LOGGER = (Log)new NullLogger("MySQL");
  ...
  public <M extends Message> MessageBuilder<M> getMessageBuilder() {
    return (MessageBuilder)this.messageBuilder;
  }
  ...
  public ProfilerEventHandler getProfilerEventHandler() {
    if (this.eventSink == null)
      synchronized (this) {
        if (this.eventSink == null) {
          this.eventSink = (ProfilerEventHandler)Util.getInstance(this.propertySet
              .getStringProperty(PropertyKey.profilerEventHandler).getStringValue(), new Class[0], new Object[0], this.exceptionInterceptor);
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\CoreSession.class
