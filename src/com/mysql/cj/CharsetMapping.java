...
public class CharsetMapping {
  ...
  static {
    MysqlCharset[] charset = { 
        ...
        new MysqlCharset("cp1256", 1, 0, new String[] { "Cp1256" }), new MysqlCharset("cp1257", 1, 0, new String[] { "Cp1257" }), new MysqlCharset("macroman", 1, 0, new String[] { "MacRoman" }), new MysqlCharset("macce", 1, 0, new String[] { "MacCentralEurope" }), new MysqlCharset("utf8", 3, 0, new String[] { "UTF-8" }), new MysqlCharset("utf8mb4", 4, 1, new String[] { "UTF-8" }), new MysqlCharset("binary", 1, 1, new String[] { "ISO8859_1" }), new MysqlCharset("ucs2", 2, 0, new String[] { "UnicodeBig" }), new MysqlCharset("utf16", 4, 0, new String[] { "UTF-16" }), new MysqlCharset("utf16le", 4, 0, new String[] { "UTF-16LE" }), 
    ...
    for (int j = 1; j < 1024; j++) {
      ...
      if (coll != null) {
        COLLATION_INDEX_TO_COLLATION_NAME[j] = coll.collationName;
        collationIndexToCharset.put(Integer.valueOf(j), coll.mysqlCharset);
        collationNameToCollationIndexMap.put(coll.collationName, Integer.valueOf(j));
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\CharsetMapping.class
