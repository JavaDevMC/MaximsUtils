...
public class NoSubInterceptorWrapper implements QueryInterceptor {
  ...
  public <T extends Resultset> T postProcess(Supplier<String> sql, Query interceptedQuery, T originalResultSet, ServerSession serverSession) {
    this.underlyingInterceptor.postProcess(sql, interceptedQuery, (Resultset)originalResultSet, serverSession);
    return null;
  }
  ...
  public <M extends Message> M preProcess(M queryPacket) {
    this.underlyingInterceptor.preProcess((Message)queryPacket);
    return null;
  }
  
  public <M extends Message> M postProcess(M queryPacket, M originalResponsePacket) {
    this.underlyingInterceptor.postProcess((Message)queryPacket, (Message)originalResponsePacket);
    return null;
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\NoSubInterceptorWrapper.class
