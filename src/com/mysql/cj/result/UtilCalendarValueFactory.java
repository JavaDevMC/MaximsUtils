  ...
  public Calendar localCreateFromTimestamp(InternalTimestamp its) {
    ...
    try {
      Calendar c = Calendar.getInstance(
          ((Boolean)this.pset.getBooleanProperty(PropertyKey.preserveInstants).getValue()).booleanValue() ? this.connectionTimeZone : this.defaultTimeZone, Locale.US);
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\result\UtilCalendarValueFactory.class
