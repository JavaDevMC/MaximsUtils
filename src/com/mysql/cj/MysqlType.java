...
public enum MysqlType implements SQLType {
  DECIMAL("DECIMAL", 3, BigDecimal.class, 64, true, Long.valueOf(65L), "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
  DECIMAL_UNSIGNED("DECIMAL UNSIGNED", 3, BigDecimal.class, 96, true, 
    Long.valueOf(65L), "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
  TINYINT("TINYINT", -6, Integer.class, 64, true, Long.valueOf(3L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  TINYINT_UNSIGNED("TINYINT UNSIGNED", -6, Integer.class, 96, true, Long.valueOf(3L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  BOOLEAN("BOOLEAN", 16, Boolean.class, 0, false, Long.valueOf(3L), ""),
  SMALLINT("SMALLINT", 5, Integer.class, 64, true, Long.valueOf(5L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  SMALLINT_UNSIGNED("SMALLINT UNSIGNED", 5, Integer.class, 96, true, 
    Long.valueOf(5L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  INT("INT", 4, Integer.class, 64, true, Long.valueOf(10L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  INT_UNSIGNED("INT UNSIGNED", 4, Long.class, 96, true, Long.valueOf(10L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  FLOAT("FLOAT", 7, Float.class, 64, true, Long.valueOf(12L), "[(M,D)] [UNSIGNED] [ZEROFILL]"),
  FLOAT_UNSIGNED("FLOAT UNSIGNED", 7, Float.class, 96, true, Long.valueOf(12L), "[(M,D)] [UNSIGNED] [ZEROFILL]"),
  DOUBLE("DOUBLE", 8, Double.class, 64, true, Long.valueOf(22L), "[(M,D)] [UNSIGNED] [ZEROFILL]"),
  DOUBLE_UNSIGNED("DOUBLE UNSIGNED", 8, Double.class, 96, true, Long.valueOf(22L), "[(M,D)] [UNSIGNED] [ZEROFILL]"),
  NULL("NULL", 0, Object.class, 0, false, Long.valueOf(0L), ""),
  TIMESTAMP("TIMESTAMP", 93, Timestamp.class, 0, false, Long.valueOf(26L), "[(fsp)]"),
  BIGINT("BIGINT", -5, Long.class, 64, true, Long.valueOf(19L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  BIGINT_UNSIGNED("BIGINT UNSIGNED", -5, BigInteger.class, 96, true, Long.valueOf(20L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  MEDIUMINT("MEDIUMINT", 4, Integer.class, 64, true, Long.valueOf(7L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  MEDIUMINT_UNSIGNED("MEDIUMINT UNSIGNED", 4, Integer.class, 96, true, 
    Long.valueOf(8L), "[(M)] [UNSIGNED] [ZEROFILL]"),
  DATE("DATE", 91, Date.class, 0, false, Long.valueOf(10L), ""),
  TIME("TIME", 92, Time.class, 0, false, Long.valueOf(16L), "[(fsp)]"),
  DATETIME("DATETIME", 93, LocalDateTime.class, 0, false, Long.valueOf(26L), "[(fsp)]"),
  YEAR("YEAR", 91, Date.class, 0, false, Long.valueOf(4L), "[(4)]"),
  VARCHAR("VARCHAR", 12, String.class, 0, false, Long.valueOf(65535L), "(M) [CHARACTER SET charset_name] [COLLATE collation_name]"),
  VARBINARY("VARBINARY", -3, null, 0, false, Long.valueOf(65535L), "(M)"),
  BIT("BIT", -7, Boolean.class, 0, true, Long.valueOf(1L), "[(M)]"),
  JSON("JSON", -1, String.class, 0, false, Long.valueOf(1073741824L), ""),
  ENUM("ENUM", 1, String.class, 0, false, Long.valueOf(65535L), "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
  SET("SET", 1, String.class, 0, false, Long.valueOf(64L), "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
  TINYBLOB("TINYBLOB", -3, null, 0, false, Long.valueOf(255L), ""),
  TINYTEXT("TINYTEXT", 12, String.class, 0, false, Long.valueOf(255L), " [CHARACTER SET charset_name] [COLLATE collation_name]"),
  MEDIUMBLOB("MEDIUMBLOB", -4, null, 0, false, Long.valueOf(16777215L), ""),
  MEDIUMTEXT("MEDIUMTEXT", -1, String.class, 0, false, Long.valueOf(16777215L), " [CHARACTER SET charset_name] [COLLATE collation_name]"),
  LONGBLOB("LONGBLOB", -4, null, 0, false, Long.valueOf(4294967295L), ""),
  LONGTEXT("LONGTEXT", -1, String.class, 0, false, Long.valueOf(4294967295L), " [CHARACTER SET charset_name] [COLLATE collation_name]"),
  BLOB("BLOB", -4, null, 0, false, Long.valueOf(65535L), "[(M)]"),
  TEXT("TEXT", -1, String.class, 0, false, Long.valueOf(65535L), "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
  CHAR("CHAR", 1, String.class, 0, false, Long.valueOf(255L), "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
  BINARY("BINARY", -2, null, 0, false, Long.valueOf(255L), "(M)"),
  GEOMETRY("GEOMETRY", -2, null, 0, false, Long.valueOf(65535L), ""),
  UNKNOWN("UNKNOWN", 1111, null, 0, false, Long.valueOf(65535L), "");
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\MysqlType.class
