  ...
  public void checkCancelTimeout() {
    synchronized (this.cancelTimeoutMutex) {
      if (this.cancelStatus != CancelStatus.NOT_CANCELED) {
        CJException cause = (this.cancelStatus == CancelStatus.CANCELED_BY_TIMEOUT) ? (CJException)new CJTimeoutException() : (CJException)new OperationCancelledException();
        resetCancelledState();
        throw cause;
      } 
    } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\AbstractQuery.class
