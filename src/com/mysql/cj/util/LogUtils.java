...
public class LogUtils {
  ...
  public static String findCallingClassAndMethod(Throwable t) {
    ...
    int endInternalMethods = Math.max(Math.max(stackTraceAsString.lastIndexOf("com.mysql.cj"), stackTraceAsString.lastIndexOf("com.mysql.cj.core")), stackTraceAsString
        .lastIndexOf("com.mysql.cj.jdbc"));
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\c\\util\LogUtils.class
