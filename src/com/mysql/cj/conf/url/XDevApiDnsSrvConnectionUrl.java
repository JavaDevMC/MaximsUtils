...
public class XDevApiDnsSrvConnectionUrl extends ConnectionUrl {
  ...
  public XDevApiDnsSrvConnectionUrl(ConnectionUrlParser connStrParser, Properties info) {
    ...
    if (hostProps.containsKey(PropertyKey.xdevapiDnsSrv.getKeyName()) && 
      !BooleanPropertyDefinition.booleanFrom(PropertyKey.xdevapiDnsSrv.getKeyName(), hostProps.get(PropertyKey.xdevapiDnsSrv.getKeyName()), null).booleanValue())
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\con\\url\XDevApiDnsSrvConnectionUrl.class
