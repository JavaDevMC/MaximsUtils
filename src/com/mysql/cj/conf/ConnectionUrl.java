...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
  ...
  public enum Type {
    ...
    SINGLE_CONNECTION("jdbc:mysql:", HostsCardinality.SINGLE, "com.mysql.cj.conf.url.SingleConnectionUrl", (HostsCardinality)PropertyKey.dnsSrv, (String)FAILOVER_DNS_SRV_CONNECTION),
    FAILOVER_CONNECTION("jdbc:mysql:", HostsCardinality.MULTIPLE, "com.mysql.cj.conf.url.FailoverConnectionUrl", (HostsCardinality)PropertyKey.dnsSrv, (String)FAILOVER_DNS_SRV_CONNECTION),
    LOADBALANCE_CONNECTION("jdbc:mysql:loadbalance:", HostsCardinality.ONE_OR_MORE, "com.mysql.cj.conf.url.LoadBalanceConnectionUrl", (HostsCardinality)PropertyKey.dnsSrv, (String)LOADBALANCE_DNS_SRV_CONNECTION),
    REPLICATION_CONNECTION("jdbc:mysql:replication:", HostsCardinality.ONE_OR_MORE, "com.mysql.cj.conf.url.ReplicationConnectionUrl", (HostsCardinality)PropertyKey.dnsSrv, (String)REPLICATION_DNS_SRV_CONNECTION),
    XDEVAPI_SESSION("mysqlx:", HostsCardinality.ONE_OR_MORE, "com.mysql.cj.conf.url.XDevApiConnectionUrl", (HostsCardinality)PropertyKey.xdevapiDnsSrv, (String)XDEVAPI_DNS_SRV_SESSION);
    ...
    Type(String scheme, HostsCardinality cardinality, String implementingClass, PropertyKey dnsSrvPropertyKey, Type alternateDnsSrvType) {
      this.scheme = scheme;
    ...
    private ConnectionUrl getImplementingInstance(ConnectionUrlParser parser, Properties info) {
      return (ConnectionUrl)Util.getInstance(getImplementingClass(), new Class[] { ConnectionUrlParser.class, Properties.class }, new Object[] { parser, info }, null);
    }
  }
  ...
  protected void setupPropertiesTransformer() {
    ...
    if (!StringUtils.isNullOrEmpty(propertiesTransformClassName))
      ...
      } catch (InstantiationException|IllegalAccessException|ClassNotFoundException|com.mysql.cj.exceptions.CJException e) {
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\conf\ConnectionUrl.class
