        ...
        if (this.paramInfo.numParameters > 0)
          for (Iterator<CallableStatementParam> paramIter = this.paramInfo.iterator(); paramIter.hasNext(); ) {
            ...
            if (!this.callingStoredFunction && outParamInfo.isOut) {
              ...
              setBytesNoEscapeNoQuotes(outParamIndex, StringUtils.getBytes(outParameterName, this.charEncoding));
            } 
          }  
      } 
      return;
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\jdbc\CallableStatement.class
