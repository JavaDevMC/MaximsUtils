...
public class ResultSetImpl extends NativeResultset implements ResultSetInternalMethods, WarningListener {
  ...
  public int findColumn(String columnName) throws SQLException {
    try {
      synchronized (checkClosed().getConnectionMutex()) {
        Integer index = Integer.valueOf(this.columnDefinition.findColumn(columnName, this.useColumnNamesInFindColumn, 1));
        if (index.intValue() == -1)
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\jdbc\result\ResultSetImpl.class
