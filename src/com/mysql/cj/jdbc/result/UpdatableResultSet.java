  ...
  private void setParamValue(ClientPreparedStatement ps, int psIdx, Row row, int rsIdx, Field field) throws SQLException {
    ...
    switch (field.getMysqlType()) {
      ...
      case DATE:
        ...
        return;
      case TIMESTAMP:
        ((PreparedQuery)ps.getQuery()).getQueryBindings().bindTimestamp(ps.getCoreParameterIndex(psIdx), getTimestamp(rsIdx + 1), null, field
            .getDecimals(), MysqlType.TIMESTAMP);
        return;
      case DATETIME:
        ps.setObject(psIdx, getObject(rsIdx + 1, LocalDateTime.class), (SQLType)MysqlType.DATETIME, field.getDecimals());
        return;
      case TIME:
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\jdbc\result\UpdatableResultSet.class
