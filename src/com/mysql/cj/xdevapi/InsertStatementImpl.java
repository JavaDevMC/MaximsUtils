...
public class InsertStatementImpl implements InsertStatement {
  ...
  public InsertResult execute() {
    return (InsertResult)this.mysqlxSession.query((Message)((XMessageBuilder)this.mysqlxSession
        .getMessageBuilder()).buildRowInsert(this.schemaName, this.tableName, this.insertParams), new InsertResultBuilder());
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\xdevapi\InsertStatementImpl.class
