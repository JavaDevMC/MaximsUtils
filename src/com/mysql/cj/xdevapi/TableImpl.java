...
public class TableImpl implements Table {
  ...
  public boolean isView() {
    if (this.isView == null) {
      ...
      if (objects.isEmpty())
        return false; 
      this.isView = Boolean.valueOf((((DatabaseObjectDescription)objects.get(0)).getObjectType() == DbObjectType.VIEW || ((DatabaseObjectDescription)objects.get(0)).getObjectType() == DbObjectType.COLLECTION_VIEW));
    } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\xdevapi\TableImpl.class
