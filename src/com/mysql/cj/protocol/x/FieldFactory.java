...
public class FieldFactory implements ProtocolEntityFactory<Field, XMessage> {
  ...
  public Field createFromMessage(XMessage message) {
    return columnMetaDataToField((MysqlxResultset.ColumnMetaData)message.getMessage(), this.metadataCharacterSet);
  }
  ...
  private Field columnMetaDataToField(MysqlxResultset.ColumnMetaData col, String characterSet) {
    try {
      ...
      String encoding = CharsetMapping.getStaticJavaEncodingForCollationIndex(Integer.valueOf(collationIndex));
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\x\FieldFactory.class
