...
public class XProtocolError extends CJException {
  ...
  public XProtocolError(XProtocolError fromOtherThread) {
    super(getFullErrorDescription(fromOtherThread.msg), (Throwable)fromOtherThread);
  ...
  public int getErrorCode() {
    return (this.msg == null) ? getVendorCode() : this.msg.getCode();
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\x\XProtocolError.class
