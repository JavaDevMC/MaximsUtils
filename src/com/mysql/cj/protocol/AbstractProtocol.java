...
public abstract class AbstractProtocol<M extends Message> implements Protocol<M>, Protocol.ProtocolEventHandler {
  ...
  public void init(Session sess, SocketConnection phConnection, PropertySet propSet, TransactionEventHandler trManager) {
    ...
    this.useNanosForElapsedTime = (((Boolean)this.propertySet.getBooleanProperty(PropertyKey.useNanosForElapsedTime).getValue()).booleanValue() && TimeUtil.nanoTimeAvailable());
  ...
  public void invokeListeners(ProtocolEventListener.EventType type, Throwable reason) {
    for (WeakReference<ProtocolEventListener> wr : this.listeners) {
      ProtocolEventListener l = wr.get();
      if (l != null) {
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\AbstractProtocol.class
