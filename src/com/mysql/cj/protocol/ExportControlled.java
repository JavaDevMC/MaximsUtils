...
public class ExportControlled {
  ...
  public static Socket performTlsHandshake(Socket rawSocket, SocketConnection socketConnection, ServerVersion serverVersion, Log log) throws IOException, SSLParamsException, FeatureNotAvailableException {
    ...
    if (log != null) {
      ...
      if ("TLSv1".equalsIgnoreCase(tlsVersion) || "TLSv1.1".equalsIgnoreCase(tlsVersion))
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\ExportControlled.class
