...
public interface Protocol<M extends Message> {
  ...
  public static interface ProtocolEventHandler {
    void addListener(ProtocolEventListener param1ProtocolEventListener);
    
    void removeListener(ProtocolEventListener param1ProtocolEventListener);
    
    void invokeListeners(ProtocolEventListener.EventType param1EventType, Throwable param1Throwable);
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\Protocol.class
