...
public class ResultsetRowsStatic extends AbstractResultsetRows implements ResultsetRows {
  ...
  public Row get(int atIndex) {
    if (atIndex < 0 || atIndex >= this.rows.size())
      return null; 
    return ((Row)this.rows.get(atIndex)).setMetadata(this.metadata);
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\a\result\ResultsetRowsStatic.class
