...
public class ResultsetRowsCursor extends AbstractResultsetRows implements ResultsetRows {
  ...
  public ResultsetRowsCursor(NativeProtocol ioChannel, ColumnDefinition columnDefinition) {
    ...
    this.rowFactory = (ProtocolEntityFactory<ResultsetRow, NativePacketPayload>)new BinaryRowFactory(this.protocol, this.metadata, Resultset.Concurrency.READ_ONLY, false);
  ...
  public Row next() {
    if (this.fetchedRows == null && this.currentPositionInEntireResult != -1)
      throw ExceptionFactory.createException(Messages.getString("ResultSet.Operation_not_allowed_after_ResultSet_closed_144"), this.protocol
  ...
  private void fetchMoreRows() {
    ...
    synchronized (this.owner.getSyncMutex()) {
      try {
        ...
        this.protocol.sendCommand((Message)this.commandBuilder
            .buildComStmtFetch(this.protocol.getSharedSendPacket(), this.owner.getOwningStatementServerId(), numRowsToFetch), true, 0);
        Row row = null;
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\a\result\ResultsetRowsCursor.class
