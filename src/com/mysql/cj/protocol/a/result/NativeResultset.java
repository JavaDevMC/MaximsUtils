...
public class NativeResultset implements Resultset {
  ...
  public NativeResultset(OkPacket ok) {
    ...
    this.columnDefinition = (ColumnDefinition)new DefaultColumnDefinition(new com.mysql.cj.result.Field[0]);
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\protocol\a\result\NativeResultset.class
