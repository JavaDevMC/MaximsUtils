...
public class NativeCharsetSettings extends CharsetMapping implements CharsetSettings {
  ...
  private boolean characterSetNamesMatches(String mysqlEncodingName) {
    return (mysqlEncodingName != null && mysqlEncodingName.equalsIgnoreCase(this.serverSession.getServerVariable("character_set_client")) && mysqlEncodingName
      .equalsIgnoreCase(this.serverSession.getServerVariable("character_set_connection")));
  }
        ...
        while ((r = (Row)rs.getRows().next()) != null) {
          ...
          if (collationIndex >= 1024 || 
            ...
            if (isDefault) {
              ...
              customCharsetNameToCollationIndex.putIfAbsent(charsetName, Integer.valueOf(collationIndex));
            } 
          } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\mysql\cj\NativeCharsetSettings.class
