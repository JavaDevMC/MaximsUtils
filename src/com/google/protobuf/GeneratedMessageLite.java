...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends GeneratedMessageLite.Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
  ...
  public int hashCode() {
    ...
    this.memoizedHashCode = Protobuf.getInstance().<GeneratedMessageLite<MessageType, BuilderType>>schemaFor(this).hashCode(this);
    return this.memoizedHashCode;
  }
  ...
  public int getSerializedSize() {
    if (this.memoizedSerializedSize == -1)
      this.memoizedSerializedSize = Protobuf.getInstance().<GeneratedMessageLite<MessageType, BuilderType>>schemaFor(this).getSerializedSize(this); 
    return this.memoizedSerializedSize;
  }
  ...
  public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
    ...
    protected Builder(MessageType defaultInstance) {
      ...
      this
        .instance = (MessageType)defaultInstance.dynamicMethod(MethodToInvoke.NEW_MUTABLE_INSTANCE);
      this.isBuilt = false;
    }
  ...
  public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
    ...
    public final <Type> int getExtensionCount(ExtensionLite<MessageType, List<Type>> extension) {
      GeneratedExtension<MessageType, List<Type>> extensionLite = (GeneratedExtension)GeneratedMessageLite.checkIsLite((ExtensionLite)extension);
      verifyExtensionContainingType(extensionLite);
    ...
    protected class ExtensionWriter {
      private final Iterator<Map.Entry<ExtensionDescriptor, Object>> iter = ExtendableMessage.this.extensions.iterator();
  ...
  public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
    ...
    public final BuilderType clearExtension(ExtensionLite<MessageType, ?> extension) {
      GeneratedExtension<MessageType, ?> extensionLite = GeneratedMessageLite.checkIsLite((ExtensionLite)extension);
      verifyExtensionContainingType(extensionLite);
      copyOnWrite();
  ...
  static final class ExtensionDescriptor implements FieldSet.FieldDescriptorLite<ExtensionDescriptor> {
    ...
    public MessageLite.Builder internalMergeFrom(MessageLite.Builder to, MessageLite from) {
      return ((Builder<GeneratedMessageLite, MessageLite.Builder>)to).mergeFrom((GeneratedMessageLite)from);
    }
  ...
  static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T instance, CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
    GeneratedMessageLite generatedMessageLite = (GeneratedMessageLite)instance.dynamicMethod(MethodToInvoke.NEW_MUTABLE_INSTANCE);
    try {
      Schema<T> schema = Protobuf.getInstance().schemaFor((T)generatedMessageLite);
      schema.mergeFrom((T)generatedMessageLite, CodedInputStreamReader.forCodedInput(input), extensionRegistry);
      schema.makeImmutable((T)generatedMessageLite);
    } catch (IOException e) {
  ...
  static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T instance, byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
    ...
    try {
      Schema<T> schema = Protobuf.getInstance().schemaFor((T)generatedMessageLite);
      schema.mergeFrom((T)generatedMessageLite, input, offset, offset + length, new ArrayDecoders.Registers(extensionRegistry));
      schema.makeImmutable((T)generatedMessageLite);
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\GeneratedMessageLite.class
