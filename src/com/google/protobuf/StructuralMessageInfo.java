...
final class StructuralMessageInfo implements MessageInfo {
  ...
  StructuralMessageInfo(ProtoSyntax syntax, boolean messageSetWireFormat, int[] checkInitialized, FieldInfo[] fields, Object defaultInstance) {
    ...
    this.fields = fields;
    this.defaultInstance = (MessageLite)Internal.<Object>checkNotNull(defaultInstance, "defaultInstance");
  }
  ...
  public static final class Builder {
    ...
    public void withSyntax(ProtoSyntax syntax) {
      this.syntax = Internal.<ProtoSyntax>checkNotNull(syntax, "syntax");
    }
    ...
    public StructuralMessageInfo build() {
      ...
      return new StructuralMessageInfo(this.syntax, this.messageSetWireFormat, this.checkInitialized, this.fields
          
          .<FieldInfo>toArray(new FieldInfo[0]), this.defaultInstance);
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\StructuralMessageInfo.class
