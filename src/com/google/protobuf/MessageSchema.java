...
final class MessageSchema<T> implements Schema<T> {
  ...
  private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, ExtensionSchema<ET> extensionSchema, T message, Reader reader, ExtensionRegistryLite extensionRegistry) throws IOException {
    ...
    try {
        ...
        try {
          ...
          switch (type(typeAndOffset)) {
            ...
            case 9:
              if (isFieldPresent(message, pos)) {
                Object mergedResult = Internal.mergeMessage(
                    UnsafeUtil.getObject(message, offset(typeAndOffset)), reader
            ...
            case 12:
              ...
              unknownFields = SchemaUtil.storeUnknownEnum(number, j, unknownFields, unknownFieldSchema);
              continue;
            case 13:
            ...
            case 30:
              ...
              unknownFields = SchemaUtil.filterUnknownEnumList(number, enumList, 
            ...
            case 68:
              UnsafeUtil.putObject(message, 
                  ...
                  offset(typeAndOffset), reader
                  .readGroupBySchemaWithCheck(getMessageFieldSchema(pos), extensionRegistry));
              setOneofPresent(message, number, pos);
              continue;
          } 
          if (unknownFields == null)
      ...
      for (int i = this.checkInitializedCount; i < this.repeatedFieldOffsetStart; i++)
        unknownFields = filterMapUnknownEnumValues(message, this.intArray[i], unknownFields, unknownFieldSchema); 
      if (unknownFields != null)
  ...
  private int parseRepeatedField(T message, byte[] data, int position, int limit, int tag, int number, int wireType, int bufferPosition, long typeAndOffset, int fieldType, long fieldOffset, ArrayDecoders.Registers registers) throws IOException {
    ...
    switch (fieldType) {
      ...
      case 44:
        ...
        unknownFields = ((GeneratedMessageLite)message).unknownFields;
        if (unknownFields == UnknownFieldSetLite.getDefaultInstance())
          unknownFields = null; 
        unknownFields = (UnknownFieldSetLite)SchemaUtil.filterUnknownEnumList(number, (List)list, 
            
            getEnumFieldVerifier(bufferPosition), unknownFields, this.unknownFieldSchema);
        if (unknownFields != null)
          ((GeneratedMessageLite)message).unknownFields = unknownFields; 
        break;
      case 33:
    ...
    switch (fieldType) {
      ...
      case 60:
        if (wireType == 2) {
          ...
          if (oldValue == null) {
            ...
            unsafe.putObject(message, fieldOffset, 
                Internal.mergeMessage(oldValue, registers.object1));
          } 
          unsafe.putInt(message, oneofCaseOffset, number);
        } 
        break;
      ...
      case 68:
        if (wireType == 3) {
          ...
          position = ArrayDecoders.decodeGroupField(
              ...
              if (wireType == 2) {
                ...
                if ((currentPresenceField & presenceMask) == 0) {
                  ...
                  unsafe.putObject(message, fieldOffset, 
                      ...
                      Internal.mergeMessage(unsafe
                        .getObject(message, fieldOffset), registers.object1));
                } 
                currentPresenceField |= presenceMask;
                continue;
              } 
  ...
  public void makeImmutable(T message) {
    ...
    for (int j = this.repeatedFieldOffsetStart; j < length; j++)
  ...
  private final <UT, UB> UB filterMapUnknownEnumValues(Object message, int pos, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
    ...
    unknownFields = filterUnknownEnumMap(pos, fieldNumber, mapData, enumVerifier, unknownFields, unknownFieldSchema);
    return unknownFields;
  }
  ...
  public final boolean isInitialized(T message) {
    ...
    for (int i = 0; i < this.checkInitializedCount; i++) {
      ...
      if (isRequired(typeAndOffset) && 
        !isFieldPresent(message, pos, currentPresenceField, presenceMask))
        return false; 
      switch (type(typeAndOffset)) {
        case 9:
        case 17:
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\MessageSchema.class
