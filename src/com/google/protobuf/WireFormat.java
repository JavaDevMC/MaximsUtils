...
public final class WireFormat {
  ...
  public enum FieldType {
    DOUBLE((String) JavaType.DOUBLE, 1),
    FLOAT((String) JavaType.FLOAT, 5),
    INT64((String) JavaType.LONG, 0),
    UINT64((String) JavaType.LONG, 0),
    INT32((String) JavaType.INT, 0),
    FIXED64((String) JavaType.LONG, 1),
    FIXED32((String) JavaType.INT, 5),
    BOOL((String) JavaType.BOOLEAN, 0),
    STRING((String) JavaType.STRING, 2) {
      public boolean isPackable() {
        return false;
      }
    },
    GROUP((String) JavaType.MESSAGE, 3) {
      public boolean isPackable() {
        return false;
      }
    },
    MESSAGE((String) JavaType.MESSAGE, 2) {
      public boolean isPackable() {
        return false;
      }
    },
    BYTES((String) JavaType.BYTE_STRING, 2) {
      public boolean isPackable() {
        return false;
      }
    },
    UINT32((String) JavaType.INT, 0),
    ENUM((String) JavaType.ENUM, 0),
    SFIXED32((String) JavaType.INT, 5),
    SFIXED64((String) JavaType.LONG, 1),
    SINT32((String) JavaType.INT, 0),
    SINT64((String) JavaType.LONG, 0);
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\WireFormat.class
