  ...
  public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
    ...
    private class EntryAdapter implements Entry<K, V> {
      ...
      public V setValue(V value) {
        RealValue oldValue = this.realEntry.setValue((RealValue) MapAdapter.this.valueConverter.doBackward(value));
        if (oldValue == null)
          return null; 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\Internal.class
