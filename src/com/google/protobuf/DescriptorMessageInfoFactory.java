...
final class DescriptorMessageInfoFactory implements MessageInfoFactory {
  ...
  private static final Set<String> specialFieldNames = new HashSet<>(
      Arrays.asList(new String[] { "cached_size", "serialized_size", "class" }));
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\protobuf\DescriptorMessageInfoFactory.class
