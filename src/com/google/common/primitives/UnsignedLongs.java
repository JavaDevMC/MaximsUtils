  ...
  public static long parseUnsignedLong(String string, int radix) {
    ...
    for (int pos = 0; pos < string.length(); pos++) {
      ...
      if (pos > maxSafePos && ParseOverflowDetection.overflowInParse(value, digit, radix)) {
        ...
        throw new NumberFormatException((String.valueOf(string).length() != 0) ? "Too large for unsigned long: ".concat(String.valueOf(string)) : new String("Too large for unsigned long: "));
      } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\primitives\UnsignedLongs.class
