...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
  ...
  public static <T> BloomFilter<T> readFrom(InputStream in, Funnel<? super T> funnel) throws IOException {
    ...
    try {
      ...
      String message = (new StringBuilder(134)).append("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ").append(i).append(" numHashFunctions: ").append(j).append(" dataLength: ").append(k).toString();
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\hash\BloomFilter.class
