...
public final class Funnels {
  ...
  private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
    ...
    public String toString() {
      String str = this.charset.name();
      return (new StringBuilder(22 + String.valueOf(str).length())).append("Funnels.stringFunnel(").append(str).append(")").toString();
    }
  ...
  private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
    ...
    public String toString() {
      String str = String.valueOf(this.elementFunnel);
      return (new StringBuilder(26 + String.valueOf(str).length())).append("Funnels.sequentialFunnel(").append(str).append(")").toString();
    }
  ...
  private static class SinkAsStream extends OutputStream {
    ...
    public String toString() {
      String str = String.valueOf(this.sink);
      return (new StringBuilder(24 + String.valueOf(str).length())).append("Funnels.asOutputStream(").append(str).append(")").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\hash\Funnels.class
