...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
  ...
  public String toString() {
    ...
    boolean bool2 = allowsParallelEdges();
    boolean bool3 = allowsSelfLoops();
    String str1 = String.valueOf(nodes());
    String str2 = String.valueOf(edgeIncidentNodesMap(this));
    return (new StringBuilder(87 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("isDirected: ").append(bool1).append(", allowsParallelEdges: ").append(bool2).append(", allowsSelfLoops: ").append(bool3).append(", nodes: ").append(str1).append(", edges: ").append(str2).toString();
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\graph\AbstractNetwork.class
