...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
  ...
  public Iterator<EndpointPair<N>> incidentEdgeIterator(final N thisNode) {
    return Iterators.transform(this.adjacentNodeValues
        .keySet().iterator(), new Function<N, EndpointPair<N>>(this) {
          public EndpointPair<N> apply(N incidentNode) {
            return EndpointPair.unordered((N)thisNode, incidentNode);
          }
        });
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\graph\UndirectedGraphConnections.class
