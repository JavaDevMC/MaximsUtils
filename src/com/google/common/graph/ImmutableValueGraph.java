  ...
  private static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> graph, final N node) {
    Function<N, V> successorNodeToValueFn = new Function<N, V>() {
        public V apply(N successorNode) {
          return Objects.requireNonNull(graph.edgeValueOrDefault(node, successorNode, null));
        }
      };
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\graph\ImmutableValueGraph.class
