...
public final class InternetDomainName {
  ...
  public InternetDomainName child(String leftParts) {
    String str1 = (String)Preconditions.checkNotNull(leftParts), str2 = this.name;
    return from((new StringBuilder(1 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".").append(str2).toString());
  }
