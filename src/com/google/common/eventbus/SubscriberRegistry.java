  ...
  void unregister(Object listener) {
    ...
    for (Map.Entry<Class<?>, Collection<Subscriber>> entry : (Iterable<Map.Entry<Class<?>, Collection<Subscriber>>>)listenerMethods.asMap().entrySet()) {
      ...
      if (currentSubscribers == null || !currentSubscribers.removeAll(listenerMethodsForType)) {
        ...
        throw new IllegalArgumentException((new StringBuilder(65 + String.valueOf(str).length())).append("missing event subscriber for an annotated method. Is ").append(str).append(" registered?").toString());
      } 
    } 
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\eventbus\SubscriberRegistry.class
