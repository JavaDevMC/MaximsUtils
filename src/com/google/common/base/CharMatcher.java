...
public abstract class CharMatcher implements Predicate<Character> {
  ...
  CharMatcher precomputedInternal() {
    ...
    String negatedDescription = description.endsWith(suffix) ? description.substring(0, description.length() - suffix.length()) : ((String.valueOf(suffix).length() != 0) ? String.valueOf(description).concat(String.valueOf(suffix)) : new String(String.valueOf(description)));
  ...
  private static class Negated extends CharMatcher {
    ...
    public String toString() {
      ...
      return (new StringBuilder(9 + String.valueOf(str).length())).append(str).append(".negate()").toString();
    }
  }
  ...
  private static final class And extends CharMatcher {
    ...
    public String toString() {
      ...
      return (new StringBuilder(19 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("CharMatcher.and(").append(str1).append(", ").append(str2).append(")").toString();
    }
  }
  ...
  private static final class Or extends CharMatcher {
    ...
    public String toString() {
      String str1 = String.valueOf(this.first), str2 = String.valueOf(this.second);
      return (new StringBuilder(18 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("CharMatcher.or(").append(str1).append(", ").append(str2).append(")").toString();
    }
  }
  ...
  private static final class Is extends FastMatcher {
    ...
    public String toString() {
      String str = CharMatcher.showCharacter(this.match);
      return (new StringBuilder(18 + String.valueOf(str).length())).append("CharMatcher.is('").append(str).append("')").toString();
    }
  }
  ...
  private static final class IsNot extends FastMatcher {
    ...
    public String toString() {
      String str = CharMatcher.showCharacter(this.match);
      return (new StringBuilder(21 + String.valueOf(str).length())).append("CharMatcher.isNot('").append(str).append("')").toString();
    }
  }
  ...
  private static final class IsEither extends FastMatcher {
    ...
    public String toString() {
      String str1 = CharMatcher.showCharacter(this.match1), str2 = CharMatcher.showCharacter(this.match2);
      return (new StringBuilder(21 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("CharMatcher.anyOf(\"").append(str1).append(str2).append("\")").toString();
    }
  }
  ...
  private static final class InRange extends FastMatcher {
    ...
    public String toString() {
      String str1 = CharMatcher.showCharacter(this.startInclusive);
      String str2 = CharMatcher.showCharacter(this.endInclusive);
      return (new StringBuilder(27 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("CharMatcher.inRange('").append(str1).append("', '").append(str2).append("')").toString();
    }
  }
  ...
  private static final class ForPredicate extends CharMatcher {
    ...
    public String toString() {
      ...
      return (new StringBuilder(26 + String.valueOf(str).length())).append("CharMatcher.forPredicate(").append(str).append(")").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\base\CharMatcher.class
