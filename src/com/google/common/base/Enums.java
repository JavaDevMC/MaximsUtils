...
public final class Enums {
  ...
  private static final class StringConverter<T extends Enum<T>> extends Converter<String, T> implements Serializable {
    ...
    public String toString() {
      String str = this.enumClass.getName();
      return (new StringBuilder(29 + String.valueOf(str).length())).append("Enums.stringConverter(").append(str).append(".class)").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\base\Enums.class
