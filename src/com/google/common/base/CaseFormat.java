...
public enum CaseFormat {
  ...
  private static final class StringConverter extends Converter<String, String> implements Serializable {
    ...
    public String toString() {
      String str1 = String.valueOf(this.sourceFormat), str2 = String.valueOf(this.targetFormat);
      return (new StringBuilder(14 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".converterTo(").append(str2).append(")").toString();
    }
  }
  ...
  private static String firstCharOnlyToUpper(String word) {
    ...
    String str = Ascii.toLowerCase(word.substring(1));
    return word.isEmpty() ? word : (new StringBuilder(1 + String.valueOf(str).length())).append(c).append(str).toString();
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\base\CaseFormat.class
