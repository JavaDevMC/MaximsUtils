...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
  ...
  public final Invokable<T, Object> method(Method method) {
    ...
    return new Invokable.MethodInvokable<T>(method) {
        ...
        public String toString() {
          String str1 = String.valueOf(getOwnerType()), str2 = super.toString();
  ...
  public final Invokable<T, T> constructor(Constructor<?> constructor) {
    ...
    return new Invokable.ConstructorInvokable<T>(constructor) {
        ...
        public String toString() {
          String str1 = String.valueOf(getOwnerType()), str2 = Joiner.on(", ").join((Object[])getGenericParameterTypes());
    ...
    protected Set<TypeToken<? super T>> delegate() {
      ...
      if (filteredTypes == null) {
        ...
        return 
          ...
          (Set<TypeToken<? super T>>)(this.types = FluentIterable.from((Iterable)collectedTypes).filter(TypeFilter.IGNORE_TYPE_VARIABLE_OR_WILDCARD).toSet());
      } 
      return (Set<TypeToken<? super T>>)filteredTypes;
    }
    
    public Set<Class<? super T>> rawTypes() {
      ImmutableList<Class<? super T>> collectedTypes = (ImmutableList) TypeCollector.FOR_RAW_TYPE.collectTypes((Iterable<? extends Class<?>>)TypeToken.this.getRawTypes());
  ...
  private final class InterfaceSet extends TypeSet {
    ...
    protected Set<TypeToken<? super T>> delegate() {
      ...
      if (result == null)
        return 
          (Set<TypeToken<? super T>>)(this.interfaces = FluentIterable.from((Iterable)this.allTypes).filter(TypeFilter.INTERFACE_ONLY).toSet());
    ...
    public Set<Class<? super T>> rawTypes() {
      ...
      return (Set<Class<? super T>>)FluentIterable.from((Iterable)collectedTypes)
        .filter(new Predicate<Class<?>>(this) {
  ...
  private final class ClassSet extends TypeSet {
    ...
    protected Set<TypeToken<? super T>> delegate() {
      ...
      if (result == null) {
        ImmutableList<TypeToken<? super T>> collectedTypes = TypeCollector.FOR_GENERIC_TYPE.classesOnly().collectTypes(TypeToken.this);
        return 
          
          (Set<TypeToken<? super T>>)(this.classes = FluentIterable.from((Iterable)collectedTypes).filter(TypeFilter.IGNORE_TYPE_VARIABLE_OR_WILDCARD).toSet());
      } 
      return (Set<TypeToken<? super T>>)result;
    }
    ...
    public Set<Class<? super T>> rawTypes() {
      ImmutableList<Class<? super T>> collectedTypes = TypeCollector.FOR_RAW_TYPE.classesOnly().collectTypes((Iterable<? extends Class<? super T>>)TypeToken.this.getRawTypes());
      return (Set<Class<? super T>>)ImmutableSet.copyOf((Collection)collectedTypes);
    }
  ...
  final TypeToken<T> rejectTypeVariables() {
    (new TypeVisitor() {
        void visitTypeVariable(TypeVariable<?> type) {
          String str = String.valueOf(TypeToken.this.runtimeType);
          throw new IllegalArgumentException((new StringBuilder(58 + String.valueOf(str).length())).append(str).append("contains a type variable and is not safe for the operation").toString());
        }
  ...
  private TypeToken<? super T> getSupertypeFromUpperBounds(Class<? super T> supertype, Type[] upperBounds) {
    ...
    String str1 = String.valueOf(supertype), str2 = String.valueOf(this);
    throw new IllegalArgumentException((new StringBuilder(23 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(" isn't a super type of ").append(str2).toString());
  }
  ...
  private TypeToken<? extends T> getSubtypeFromLowerBounds(Class<?> subclass, Type[] lowerBounds) {
    ...
    String str1 = String.valueOf(subclass), str2 = String.valueOf(this);
    throw new IllegalArgumentException((new StringBuilder(21 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(" isn't a subclass of ").append(str2).toString());
  }
  ...
  private TypeToken<? extends T> getArraySubtype(Class<?> subclass) {
    ...
    if (subclassComponentType == null) {
      String str1 = String.valueOf(subclass), str2 = String.valueOf(this);
      throw new IllegalArgumentException((new StringBuilder(36 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(" does not appear to be a subtype of ").append(str2).toString());
    } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\reflect\TypeToken.class
