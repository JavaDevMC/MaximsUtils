  ...
  private static final class InCompletionOrderFuture<T> extends AbstractFuture<T> {
    ...
    public boolean cancel(boolean interruptIfRunning) {
      ...
      if (super.cancel(interruptIfRunning)) {
        ((InCompletionOrderState)Objects.<InCompletionOrderState>requireNonNull(localState)).recordOutputCancellation(interruptIfRunning);
        return true;
      } 
      return false;
    }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\commo\\util\concurrent\Futures.class
