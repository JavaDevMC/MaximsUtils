...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
  ...
  private static abstract class AtomicHelper {
    ...
    abstract void putThread(Waiter param1Waiter, Thread param1Thread);
    
    abstract void putNext(Waiter param1Waiter1, @CheckForNull AbstractFuture.Waiter param1Waiter2);
    ...
    abstract boolean casListeners(AbstractFuture<?> param1AbstractFuture, @CheckForNull AbstractFuture.Listener param1Listener1, Listener param1Listener2);
  ...
  private static final class UnsafeAtomicHelper extends AtomicHelper {
    ...
    void putNext(Waiter waiter, @CheckForNull AbstractFuture.Waiter newValue) {
    ...
    boolean casListeners(AbstractFuture<?> future, @CheckForNull AbstractFuture.Listener expect, Listener update) {
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\commo\\util\concurrent\AbstractFuture.class
