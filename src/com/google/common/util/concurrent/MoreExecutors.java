...
public final class MoreExecutors {
  ...
  static class Application {
    ...
    final void addDelayedShutdownHook(final ExecutorService service, final long terminationTimeout, final TimeUnit timeUnit) {
      ...
      addShutdownHook(
          MoreExecutors.newThread((new StringBuilder(24 + String.valueOf(str).length())).append("DelayedShutdownHook-for-").append(str).toString(), new Runnable(this) {
              public void run() {
                try {
                  service.shutdown();
  ...
  private static class ListeningDecorator extends AbstractListeningExecutorService {
    ...
    public final String toString() {
      String str1 = super.toString(), str2 = String.valueOf(this.delegate);
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\commo\\util\concurrent\MoreExecutors.class
