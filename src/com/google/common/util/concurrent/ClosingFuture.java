...
public final class ClosingFuture<V> {
  ...
  public static class Combiner {
    ...
    public static interface CombiningCallable<V> {
      @ParametricNullness
      V call(DeferredCloser param2DeferredCloser, Peeker param2Peeker) throws Exception;
    }
    
    @FunctionalInterface
    public static interface AsyncCombiningCallable<V> {
      ClosingFuture<V> call(DeferredCloser param2DeferredCloser, Peeker param2Peeker) throws Exception;
    }
  }
  ...
  public static final class Combiner2<V1, V2> extends Combiner {
    ...
    public static interface ClosingFunction2<V1, V2, U> {
      @ParametricNullness
      U apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2) throws Exception;
    }
    
    @FunctionalInterface
    public static interface AsyncClosingFunction2<V1, V2, U> {
      ClosingFuture<U> apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2) throws Exception;
    }
  }
  ...
  public static final class Combiner3<V1, V2, V3> extends Combiner {
      ...
      return call(new CombiningCallable<U>() {
            ...
            public U call(DeferredCloser closer, Peeker peeker) throws Exception {
              return (U)function.apply(closer, peeker
                  ...
                  .getDone(Combiner3.this.future1), peeker
                  .getDone(Combiner3.this.future2), peeker
                  .getDone(Combiner3.this.future3));
            }
    ...
    public static interface ClosingFunction3<V1, V2, V3, U> {
      @ParametricNullness
      U apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3) throws Exception;
    }
    
    @FunctionalInterface
    public static interface AsyncClosingFunction3<V1, V2, V3, U> {
      ClosingFuture<U> apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3) throws Exception;
    }
  }
  ...
  public static final class Combiner4<V1, V2, V3, V4> extends Combiner {
      ...
      return call(new CombiningCallable<U>() {
            ...
            public U call(DeferredCloser closer, Peeker peeker) throws Exception {
              return (U)function.apply(closer, peeker
                  ...
                  .getDone(Combiner4.this.future1), peeker
                  .getDone(Combiner4.this.future2), peeker
                  .getDone(Combiner4.this.future3), peeker
                  .getDone(Combiner4.this.future4));
            }
    ...
    public static interface ClosingFunction4<V1, V2, V3, V4, U> {
      @ParametricNullness
      U apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3, @ParametricNullness V4 param2V4) throws Exception;
    }
    
    @FunctionalInterface
    public static interface AsyncClosingFunction4<V1, V2, V3, V4, U> {
      ClosingFuture<U> apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3, @ParametricNullness V4 param2V4) throws Exception;
    }
  }
  ...
  public static final class Combiner5<V1, V2, V3, V4, V5> extends Combiner {
      ...
      return call(new CombiningCallable<U>() {
            ...
            public U call(DeferredCloser closer, Peeker peeker) throws Exception {
              return (U)function.apply(closer, peeker
                  ...
                  .getDone(Combiner5.this.future1), peeker
                  .getDone(Combiner5.this.future2), peeker
                  .getDone(Combiner5.this.future3), peeker
                  .getDone(Combiner5.this.future4), peeker
                  .getDone(Combiner5.this.future5));
            }
    ...
    public static interface ClosingFunction5<V1, V2, V3, V4, V5, U> {
      @ParametricNullness
      U apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3, @ParametricNullness V4 param2V4, @ParametricNullness V5 param2V5) throws Exception;
    }
    
    @FunctionalInterface
    public static interface AsyncClosingFunction5<V1, V2, V3, V4, V5, U> {
      ClosingFuture<U> apply(DeferredCloser param2DeferredCloser, @ParametricNullness V1 param2V1, @ParametricNullness V2 param2V2, @ParametricNullness V3 param2V3, @ParametricNullness V4 param2V4, @ParametricNullness V5 param2V5) throws Exception;
    }
  }
  ...
  public static interface ValueAndCloserConsumer<V> {
    void accept(ValueAndCloser<V> param1ValueAndCloser);
  }
  
  @FunctionalInterface
  public static interface AsyncClosingFunction<T, U> {
    ClosingFuture<U> apply(DeferredCloser param1DeferredCloser, @ParametricNullness T param1T) throws Exception;
  }
  
  @FunctionalInterface
  public static interface ClosingFunction<T, U> {
    @ParametricNullness
    U apply(DeferredCloser param1DeferredCloser, @ParametricNullness T param1T) throws Exception;
  }
  
  @FunctionalInterface
  public static interface AsyncClosingCallable<V> {
    ClosingFuture<V> call(DeferredCloser param1DeferredCloser) throws Exception;
  }
  
  @FunctionalInterface
  public static interface ClosingCallable<V> {
    @ParametricNullness
    V call(DeferredCloser param1DeferredCloser) throws Exception;
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\commo\\util\concurrent\ClosingFuture.class
