...
class MapMakerInternalMap<K, V, E extends MapMakerInternalMap.InternalEntry<K, V, E>, S extends MapMakerInternalMap.Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
  ...
  static abstract class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
    ...
    abstract E castForTesting(InternalEntry<K, V, ?> param1InternalEntry);
    ...
    void drainKeyReferenceQueue(ReferenceQueue<K> keyReferenceQueue) {
      ...
      while ((ref = keyReferenceQueue.poll()) != null) {
        InternalEntry internalEntry = (InternalEntry)ref;
      ...
      try {
        if (this.count != 0) {
          ...
          for (int i = 0; i < length; i++) {
            for (InternalEntry internalEntry = (InternalEntry)table.get(i); internalEntry != null; internalEntry = (InternalEntry)internalEntry.getNext()) {
    ...
    V put(K key, int hash, V value, boolean onlyIfAbsent) {
      ...
      try {
        ...
        InternalEntry internalEntry1 = (InternalEntry)table.get(index);
        for (InternalEntry internalEntry2 = internalEntry1; internalEntry2 != null; internalEntry2 = (InternalEntry)internalEntry2.getNext()) {
    ...
    void expand() {
      ...
      for (int oldIndex = 0; oldIndex < oldCapacity; oldIndex++) {
        InternalEntry internalEntry = (InternalEntry)oldTable.get(oldIndex);
        if (internalEntry != null) {
          ...
          if (next == null) {
            ...
            E e1;
            InternalEntry internalEntry1 = internalEntry;
            ...
            for (InternalEntry internalEntry2 = internalEntry; internalEntry2 != e1; internalEntry2 = (InternalEntry)internalEntry2.getNext()) {
              int newIndex = internalEntry2.getHash() & newMask;
              InternalEntry internalEntry3 = (InternalEntry)newTable.get(newIndex);
    ...
    V replace(K key, int hash, V newValue) {
      ...
      try {
        ...
        for (internalEntry2 = internalEntry1; internalEntry2 != null; internalEntry2 = (InternalEntry)internalEntry2.getNext()) {
          K entryKey = (K)internalEntry2.getKey();
          if (internalEntry2.getHash() == hash && entryKey != null && this.map.keyEquivalence
      ...
      try {
        ...
        for (InternalEntry internalEntry2 = internalEntry1; internalEntry2 != null; internalEntry2 = (InternalEntry)internalEntry2.getNext()) {
          ...
          if (internalEntry2.getHash() == hash && entryKey != null && this.map.keyEquivalence
            ...
            .equivalent(key, entryKey)) {
            WeakValueReference<K, V, E> v = ((WeakValueEntry<K, V, E>)internalEntry2).getValueReference();
            if (v == valueReference) {
              this.modCount++;
              E newFirst = removeFromChain((E)internalEntry1, (E)internalEntry2);
              newCount = this.count - 1;
  ...
  static final class StrongKeyWeakValueSegment<K, V> extends Segment<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
    ...
    public WeakValueReference<K, V, StrongKeyWeakValueEntry<K, V>> newWeakValueReferenceForTesting(InternalEntry<K, V, ?> e, V value) {
      return new WeakValueReferenceImpl<>(this.queueForValues, value, castForTesting(e));
    }
    ...
    public void setWeakValueReferenceForTesting(InternalEntry<K, V, ?> e, WeakValueReference<K, V, ? extends InternalEntry<K, V, ?>> valueReference) {
      ...
      WeakValueReference<K, V, ? extends InternalEntry<K, V, ?>> weakValueReference = valueReference;
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\MapMakerInternalMap.class
