          ...
          protected C computeNext() {
            while (!this.elemItr.hasNext()) {
              if (this.rangeItr.hasNext()) {
                this.elemItr = ContiguousSet.<C>create(this.rangeItr.next(), AsSet.this.domain).iterator();
                continue;
              } 
              return endOfData();
            } 
    ...
    public UnmodifiableIterator<C> descendingIterator() {
      return new AbstractIterator<C>() {
          ...
          protected C computeNext() {
            while (!this.elemItr.hasNext()) {
              if (this.rangeItr.hasNext()) {
                this.elemItr = ContiguousSet.<C>create(this.rangeItr.next(), AsSet.this.domain).descendingIterator();
                continue;
              } 
              return endOfData();
            } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\ImmutableRangeSet.class
