...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements Predicate<C>, Serializable {
  ...
  public Range<C> gap(Range<C> otherRange) {
    if (this.lowerBound.compareTo(otherRange.upperBound) < 0 && otherRange.lowerBound
      .compareTo(this.upperBound) < 0) {
      String str1 = String.valueOf(this), str2 = String.valueOf(otherRange);
      throw new IllegalArgumentException((new StringBuilder(39 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Ranges have a nonempty intersection: ").append(str1).append(", ").append(str2).toString());
    } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\Range.class
