...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
  ...
  static <R, C, V> ImmutableTable<R, C, V> copyOf(Iterable<? extends Cell<? extends R, ? extends C, ? extends V>> cells) {
  ...
  public static final class Builder<R, C, V> {
    ...
    public Builder<R, C, V> put(Cell<? extends R, ? extends C, ? extends V> cell) {
      if (cell instanceof Tables.ImmutableCell) {
        ...
        Cell<? extends R, ? extends C, ? extends V> cell1 = cell;
    ...
    public ImmutableTable<R, C, V> buildOrThrow() {
      ...
      switch (size) {
        ...
        case 1:
          return new SingletonImmutableTable<>(Iterables.<Cell<R, C, V>>getOnlyElement(this.cells));
      } 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\ImmutableTable.class
