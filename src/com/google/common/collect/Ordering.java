...
public abstract class Ordering<T> implements Comparator<T> {
  ...
  static class IncomparableValueException extends ClassCastException {
    ...
    IncomparableValueException(Object value) {
      super((new StringBuilder(22 + String.valueOf(str).length())).append("Cannot compare value: ").append(str).toString());
      this.value = value;
    }
  }
}
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\Ordering.class
