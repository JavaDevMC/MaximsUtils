...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMultiset<E> implements Serializable {
  ...
  private void checkIsE(Object element) {
    ...
    if (!isActuallyE(element)) {
      String str1 = String.valueOf(this.type), str2 = String.valueOf(element);
      throw new ClassCastException((new StringBuilder(21 + String.valueOf(str1).length() + String.valueOf(str2).length())).append("Expected an ").append(str1).append(" but got ").append(str2).toString());
    } 
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\EnumMultiset.class
