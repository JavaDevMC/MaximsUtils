  ...
  class EntrySetView extends Maps.EntrySet<K, V> {
    ...
    public Spliterator<Entry<K, V>> spliterator() {
      ...
      return (delegate != null) ? 
        ...
        CollectSpliterators.<Entry<K, V>>indexed(CompactHashMap.this
          .size, 17, x$0 -> new MapEntry(x$0));
    }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\CompactHashMap.class
