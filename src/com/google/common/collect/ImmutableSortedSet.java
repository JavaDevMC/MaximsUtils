...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    private void sortAndDedup() {
      ...
      for (int i = 1; i < this.n; i++) {
        ...
        if (cmp < 0) {
          ...
          String str = String.valueOf(this.comparator);
          throw new AssertionError((new StringBuilder(48 + String.valueOf(str).length())).append("Comparator ").append(str).append(" compare method violates its contract").toString());
        } 
      } 
  ...
  private static class SerializedForm<E> implements Serializable {
    ...
    Object readResolve() {
      return (new Builder((Comparator)this.comparator)).add(this.elements).build();
    }
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\ImmutableSortedSet.class
