...
final class SparseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
  ...
  SerializedForm createSerializedForm() {
    ...
    int i = 0;
    for (UnmodifiableIterator<Cell<R, C, V>> unmodifiableIterator = cellSet().iterator(); unmodifiableIterator.hasNext(); ) {
      Cell<R, C, V> cell = unmodifiableIterator.next();
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\SparseImmutableTable.class
