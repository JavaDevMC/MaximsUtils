...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
  ...
  private class ValueForKeyIterator implements ListIterator<V> {
    ...
    ValueForKeyIterator(K key) {
      this.key = key;
      KeyList<K, V> keyList = (KeyList<K, V>)LinkedListMultimap.this.keyToKeyList.get(key);
  ...
  public List<V> get(@ParametricNullness final K key) {
    return new AbstractSequentialList<V>() {
        ...
        public ListIterator<V> listIterator(int index) {
          return new ValueForKeyIterator((K)key, index);
        }
      };
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\LinkedListMultimap.class
