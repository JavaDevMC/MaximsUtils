...
public abstract class ForwardingNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V> {
  ...
  protected Map.Entry<K, V> standardPollFirstEntry() {
    return Iterators.<Entry<K, V>>pollNext(entrySet().iterator());
  }
  ...
  protected Map.Entry<K, V> standardPollLastEntry() {
    return Iterators.<Entry<K, V>>pollNext(descendingMap().entrySet().iterator());
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\ForwardingNavigableMap.class
