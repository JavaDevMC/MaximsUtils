    ...
    Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {
      ...
      return new AbstractIterator<Entry<Cut<C>, Range<C>>>() {
          ...
          protected Map.Entry<Cut<C>, Range<C>> computeNext() {
            ...
            if (ComplementRangesByLowerBound.this.complementLowerBoundWindow.upperBound.isLessThan(this.nextComplementRangeLowerBound) || this.nextComplementRangeLowerBound ==
              Cut.aboveAll())
              return endOfData(); 
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\TreeRangeSet.class
