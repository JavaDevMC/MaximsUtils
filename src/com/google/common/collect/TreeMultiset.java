...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
  ...
  private enum Aggregate {
    ...
    abstract int nodeAggregate(AvlNode<?> param1AvlNode);
  ...
  Iterator<Entry<E>> entryIterator() {
    return (Iterator)new Iterator<Entry<Entry<E>>>() {
        ...
        public Entry<E> next() {
          ...
          Entry<E> result = TreeMultiset.this.wrapEntry(Objects.<AvlNode>requireNonNull(this.current));
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\TreeMultiset.class
