...
public abstract class DiscreteDomain<C extends Comparable> {
  ...
  C offset(C origin, long distance) {
    ...
    for (i = 0L; i < distance; i++) {
      ...
      if (current == null) {
        String str = String.valueOf(origin);
        throw new IllegalArgumentException((new StringBuilder(51 + String.valueOf(str).length())).append("overflowed computing offset(").append(str).append(", ").append(distance).append(")").toString());
      } 
    } 
    return current;
  }
...
/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\collect\DiscreteDomain.class
