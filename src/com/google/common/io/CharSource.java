...
public abstract class CharSource {
  ...
  private final class AsByteSource extends ByteSource {
    ...
    public String toString() {
      String str1 = CharSource.this.toString(), str2 = String.valueOf(this.charset);
      return (new StringBuilder(15 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".asByteSource(").append(str2).append(")").toString();
    }
  }
  ...
  private static class CharSequenceCharSource extends CharSource {
    ...
    public String toString() {
      String str = Ascii.truncate(this.seq, 30, "...");
      return (new StringBuilder(17 + String.valueOf(str).length())).append("CharSource.wrap(").append(str).append(")").toString();
    }
  }
  ...
  private static final class ConcatenatedCharSource extends CharSource {
    ...
    public String toString() {
      ...
      return (new StringBuilder(19 + String.valueOf(str).length())).append("CharSource.concat(").append(str).append(")").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\io\CharSource.class
