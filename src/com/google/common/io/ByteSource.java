...
public abstract class ByteSource {
  ...
  class AsCharSource extends CharSource {
    ...
    public String toString() {
      String str1 = ByteSource.this.toString(), str2 = String.valueOf(this.charset);
      return (new StringBuilder(15 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".asCharSource(").append(str2).append(")").toString();
    }
  }
  ...
  private final class SlicedByteSource extends ByteSource {
    ...
    public String toString() {
      String str = ByteSource.this.toString();
      long l1 = this.offset, l2 = this.length;
      return (new StringBuilder(50 + String.valueOf(str).length())).append(str).append(".slice(").append(l1).append(", ").append(l2).append(")").toString();
    }
  }
  ...
  private static class ByteArrayByteSource extends ByteSource {
    ...
    public String toString() {
      String str = Ascii.truncate(BaseEncoding.base16().encode(this.bytes, this.offset, this.length), 30, "...");
      return (new StringBuilder(17 + String.valueOf(str).length())).append("ByteSource.wrap(").append(str).append(")").toString();
    }
  }
  ...
  private static final class ConcatenatedByteSource extends ByteSource {
    ...
    public String toString() {
      String str = String.valueOf(this.sources);
      return (new StringBuilder(19 + String.valueOf(str).length())).append("ByteSource.concat(").append(str).append(")").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\io\ByteSource.class
