...
public abstract class BaseEncoding {
  ...
  private static final class Alphabet {
    ...
    Alphabet(String name, char[] chars) {
      ...
      try {
        ...
        String.valueOf(new String(chars));
        throw new IllegalArgumentException((String.valueOf(new String(chars)).length() != 0) ? "Illegal alphabet ".concat(String.valueOf(new String(chars))) : new String("Illegal alphabet "), e);
      } 
    ...
    int decode(char ch) throws DecodingException {
      if (ch > '') {
        String.valueOf(Integer.toHexString(ch));
        throw new DecodingException((String.valueOf(Integer.toHexString(ch)).length() != 0) ? "Unrecognized character: 0x".concat(String.valueOf(Integer.toHexString(ch))) : new String("Unrecognized character: 0x"));
      } 
            ...
            while (true) {
              ...
              if (StandardBaseEncoding.this.paddingChar != null && StandardBaseEncoding.this.paddingChar.charValue() == ch) {
                if (!this.hitPadding && (this.readChars == 1 || 
                  !StandardBaseEncoding.this.alphabet.isValidPaddingStartPosition(this.readChars - 1))) {
                  int i = this.readChars;
              ...
              if (this.hitPadding) {
                int i = this.readChars;
                throw new DecodingException((new StringBuilder(61)).append("Expected padding character but found '").append(ch).append("' at index ").append(i).toString());
              } 
  ...
  static final class SeparatedBaseEncoding extends BaseEncoding {
    ...
    public String toString() {
      String str1 = String.valueOf(this.delegate), str2 = this.separator;
      int i = this.afterEveryChars;
      return (new StringBuilder(31 + String.valueOf(str1).length() + String.valueOf(str2).length())).append(str1).append(".withSeparator(\"").append(str2).append("\", ").append(i).append(")").toString();
    }
  }
}


/* Location:              C:\Users\Win10\Desktop\VoxilityCraftServer\Bungee\BungeeCord.jar!\com\google\common\io\BaseEncoding.class
